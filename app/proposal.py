...
# 문서라서다. 여기 적힌 것은 전부 확인된 사실이어야 한다 (초안 2026-09-20).
BOTTLING_INTRO = [
    "바틀링은 서울 자양동, 뚝섬한강공원 인근에 있는 셀프탭 크래프트 맥주 펍입니다.",
    "12개의 셀프탭에서 원하는 만큼 맥주를 따라 마시고 마신 양만큼 결제하는 방식으로 운영합니다.",
    "크래프트 맥주와 함께 주변 소상공인이 만든 완제품을 안주로 판매하고 있습니다.",
    "이번 제안은 협력사에서 만든 메뉴를 바틀링이 매입해 안주로 판매하는 형태의 협업입니다.",
